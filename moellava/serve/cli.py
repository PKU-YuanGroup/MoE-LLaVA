...
if __name__ == "__main__":
    ...
    main(args)
# python3 -m moellava.serve.cli --model-path "./checkpoints/moellava-7b-IM-mlp2x_gelu-V-2e2-sparse-resFalse" --image-file "image.jpg" --load-4bit
# python3 -m moellava.serve.cli --model-path "./checkpoints/llava-v1.5-7b" --image-file "image.jpg" --load-4bit