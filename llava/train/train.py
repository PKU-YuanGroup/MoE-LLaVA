...
def preprocess_multimodal(
    ...
    for source in sources:
        for sentence in source:
            ...
            # ======================================================================================================
            if DEFAULT_IMAGE_TOKEN in sentence['value'] or DEFAULT_VIDEO_TOKEN in sentence['value']:  # run with multi-im, multi-vid, multi-im & multi-vid
                # xxxxxxxxxxxxx\n<video><video><image><image> -> <video><video><image><image>\nxxxxxxxxxxxxx  # must <video> first
                # xxxxxxxxxxxxx\n<image> -> <image>\nxxxxxxxxxxxxx
                # xxxxxxxxxxxxx\n<video> -> <video>\nxxxxxxxxxxxxx
                # <image>\nxxxxxxxxxxxxx -> <image>\nxxxxxxxxxxxxx
                # <video>\nxxxxxxxxxxxxx -> <video>\nxxxxxxxxxxxxx
                ...
                if DEFAULT_VIDEO_TOKEN in sentence['value']:
                    ...
                    # print('add vid token:', [sentence['value']])
                    sentence['value'] = sentence['value'].strip()
