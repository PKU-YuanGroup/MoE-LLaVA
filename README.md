...
## 📰 News
* **[2024.01.31]**  🔥 We release a stronger [MoE-LLaVA-Phi2](https://huggingface.co/LanguageBind/MoE-LLaVA-Phi2-2.7B-4e-384) that trained on 384×384, which surpasses LLaVA-1.5-7B on 6 out of 9 benchmarks using 3.6B activated parameters.
